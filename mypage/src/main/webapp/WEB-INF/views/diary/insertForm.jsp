...
function insertCata() {
	...
	location.href ='${path}/diaryCatagory/insert?name='+ name +'&insertForm='+ 'insertForm';
}
function cataReset() {
	$("#inputTd").hide();
	$("#select1").show();
	...
	<div id="mainContainer" align="center">
		...
		<div class="container" align="center"
			...
			<div>
				...
				<span style="font-family: 'Lilly'; font-size: 20px"> <a
					onclick="openSearch1()">stickerSearch</a></span>
			</div>
			<p>
			<p>
			<p>
			...
			<div class="input-group mb-3">
				...
				<input type="text" name="keyword" value="${hashAndSti.keyword}"
					id="st" class="form-control" aria-label="Recipient's username"
					aria-describedby="basic-addon2">
				<div class="input-group-append">
					<button onclick="stiker_SLoad()" class="btn btn-outline-secondary"
